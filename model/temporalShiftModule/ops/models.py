...
class TSN(nn.Module):
    ...
    def forward(self, input, no_reshape=False, get_emb = False):
        if not no_reshape:
        ...
        if self.dropout > 0 and not get_emb:
